<template>
  ...
  >
    <div class="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
      <div class="w-full">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Statistik Penerima Manfaat </h3>
        <p class="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
          Jumlah siswa yang menerima paket makan
        </p>
      </div>
...
const series = ref([
  {
    name: 'Penerima',
    data: [3200, 3400, 3500, 3800, 4000, 3500, 4400, 4600, 4800, 3000, 3500, 3700],
    },
    {
    name: 'Paket Terkirim',
    data: [3700, 3900, 3600, 4300, 4500, 3800, 4900, 5100, 5300, 3500, 4000, 4200],
  },
])
