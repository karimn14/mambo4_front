  ...
  >
    ...
    >
      <div class="flex justify-between">
        <div>
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Jumlah Paket Tersalurkan Bulan Ini</h3>
          <p class="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
            Total penerima manfaat per Januari
          </p>
        </div>
        <div>
      ...
      <p class="mx-auto mt-1.5 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
        Penerima paket makan bergizi bulan ini sejumlah 5,359 siswa. Mari kita tingkatkan lagi!
      </p>
    </div>
